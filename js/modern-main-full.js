...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      about_title1: "About",
      about_title2: "Electric Youssef",
      about_sub: "Your trusted partner for all smartphone repairs in ZERARDA. Quality, speed, and reliability you can count on.",
      our_story: "Our Story",
      story_p1: "Electric Youssef was founded with a simple mission: to provide ZERARDA residents with fast, reliable, and affordable smartphone repair services.",
      ...
      why_heading: "Why Choose Electric Youssef?",
    ...
    fr: {
      ...
      about_title2: "d'Electric Youssef",
      about_sub: "Votre partenaire de confiance pour les réparations de téléphones à ZERARDA.",
      our_story: "Notre Histoire",
      story_p1: "Electric Youssef a été fondé avec une mission simple: fournir des réparations rapides et fiables.",
      ...
      why_heading: "Pourquoi Choisir Electric Youssef?",
  ...
  console.log('Electric Youssef - Modern Full UI Loaded Successfully 🚀');
