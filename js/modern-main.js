...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      // About Page
      about_heading: "About Electro Youssef",
      about_sub: "Your trusted partner for professional phone repair services in ZERARDA, Algeria.",
      ...
      our_story_p1: "Electro Youssef was founded with a simple mission: to provide professional, reliable phone repair services to the ZERARDA community. We understand how frustrating it is when your phone isn't working, and we're here to help.",
      ...
      address: "Address",
      address_val: "Main Street, ZERARDA, Algeria",
      phone: "Phone",
      whatsapp: "WhatsApp",
    ...
    fr: {
      ...
      hero_desc: "Expert en réparation de smartphones avec pièces authentiques et service rapide. Votre appareil est entre de bonnes mains chez Electro Youssef.",
      btn_book: "📅 Réserver",
      btn_call: "📞 Appeler",
      btn_quote: "💰 Devis",
      ...
      t1_text: "Réparé mon écran iPhone en seulement 25 minutes! La qualité est incroyable et le prix très juste. Hautement recommandé Electro Youssef!",
      t1_name: "Ahmed K.",
      ...
      about_heading: "À Propos de Electro Youssef",
      about_sub: "Votre partenaire de confiance pour les services de réparation téléphonique professionnelle à ZERARDA, Algérie.",
      ...
      our_story_p1: "Electro Youssef a été fondé avec une mission simple: fournir des services de réparation téléphonique professionnelle et fiable à la communauté de ZERARDA. Nous comprenons à quel point c'est frustrant quand votre téléphone ne fonctionne pas, et nous sommes là pour aider.",
      ...
      address: "Adresse",
      address_val: "Rue Principale, ZERARDA, Algérie",
      phone: "Téléphone",
      whatsapp: "WhatsApp",
    ...
    ar: {
      ...
      about_sub: "شريكك الموثوق لخدمات إصلاح الهواتف المحترفة في زراردة، الجزائر.",
      ...
      address: "العنوان",
      address_val: "الشارع الرئيسي، زراردة، الجزائر",
      phone: "الهاتف",
      whatsapp: "واتساب",
  ...
  const WHATSAPP_NUMBER = '212690992767';
